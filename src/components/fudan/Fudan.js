						...
						<Row>
							...
							<Col xs={12} sm={12} md={12} lg={12} xl={5}>
								<p style={{ paddingTop: '20px' }}>
									One of the many interests and goals of ARC
									is building relationships, funding and
									mentoring for scholars, students and those
									seeking a greater eduction both in the East
									and the West.
								</p>
