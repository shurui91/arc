	...
	render() {
		return (
			<div className="about">
				...
				<ListGroup>
					<ListGroup.Item>
						Bridge the gap between the East and West in targeted areas such as culture, language, medicine
						and religion
					</ListGroup.Item>
					<ListGroup.Item>
						Establish an eminent research and education center to train scholars and produce world class and
						impactful research
					</ListGroup.Item>
					<ListGroup.Item>
