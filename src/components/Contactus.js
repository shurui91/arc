...
const Contactus = () => {
    return (
        <div className='contactus-container'>
            ...
            <ContactInfo
                name='Charles Zhang, Treasurer'
                phone='949-201-8270'
                email='charleszhang58@yahoo.com'
            />
            <Introduction />
            <ContactInfo
                name='Abraham Ho, Director of Research'
