...
class LocalizeCarousel extends React.PureComponent {
	constructor(props) {
		super(props);
		this.state = {
			autoplay: true,
				...
				<Row>
					<Col sm={12} style={{ paddingTop: '20px' }}>
						<RBCarousel
							...
							<div style={{ ...styles }}>
								<img
									src={require('../../events/2012Localize/20200814010641.png')}
							...
							<div style={{ ...styles }}>
								<img
									src={require('../../events/2012Localize/20200814010651.png')}
									style={{ width: '100%', height: '100%' }}
									alt=''
								/>
								{/* <div className="carousel-caption">Image</div> */}
