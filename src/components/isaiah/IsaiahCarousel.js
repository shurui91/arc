...
class IsaiahCarousel extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            autoplay: true
                ...
                <Row>
                    <Col sm={12} style={{ paddingTop: '20px' }}>
                        ...
                        >
                            ...
                            <div style={{ ...styles }}>
                                <img
                                    src={require('../../events/Isaiah/Isaiah2.jpg')}
                                    style={{ width: '100%', height: '100%' }}
                                    alt=""
                                />
                                {/* <div className="carousel-caption">Image</div> */}
                            ...
                            <div style={{ ...styles }}>
                                <img
                                    src={require('../../events/Isaiah/Isaiah4.jpg')}
                                    style={{ width: '100%', height: '100%' }}
                                    alt=""
                                />
                                {/* <div className="carousel-caption">Image</div> */}
                            ...
                            <div style={{ ...styles }}>
                                <img
                                    src={require('../../events/Isaiah/Isaiah6.jpg')}
                                    style={{ width: '100%', height: '100%' }}
                                    alt=""
                                />
                                {/* <div className="carousel-caption">Image</div> */}
